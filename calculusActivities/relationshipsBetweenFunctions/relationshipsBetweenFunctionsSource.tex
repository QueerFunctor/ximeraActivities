\shortdescription{In this activity we explore relationships between functions.} % A one sentence description of the activity
\activitytitle{Relationships Between Functions} % the title of the activity
